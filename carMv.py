...
HOST = '192.168.0.69'    # Server(Raspberry Pi) IP address
PORT = 21567
...
# Exit the GUI program and close the network connection with the server.
...
#bind the buttons to the corresponding callback function
